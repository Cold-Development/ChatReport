package dev.padrewin.chatreport.manager;
...
import dev.padrewin.chatreport.commands.Commander;
...
public class CommandManager extends Manager {
    ...
    public void reload() {
        ...
        // Register commands
        Commander commander = new Commander((ChatReport) this.coldPlugin);
        PluginCommand command = this.coldPlugin.getCommand("chatreport");
        if (command != null)
