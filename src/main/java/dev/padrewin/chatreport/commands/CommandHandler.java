...
public abstract class CommandHandler implements TabExecutor, NamedExecutor {
     ...
     */
    public CommandHandler(ChatReport plugin, String cmd, CommandManager.CommandAliases aliases) {
        this.plugin = plugin;
        this.cmd = cmd;
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        ...
        try {
            ...
            sender.sendMessage(ChatColor.RED + "A ChatReport error occurred while executing that command. Did you enter an invalid parameter?");
        }
